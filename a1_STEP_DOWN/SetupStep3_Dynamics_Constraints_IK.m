...
constraint = [SymbolicEngine.LinkArray(21).AbsoluteFollower(2)];
% ;...
%                 SymbolicEngine.LinkArray(11).AbsoluteFollower(:);...
%                 SymbolicEngine.LinkArray(16).AbsoluteFollower(:);...
%                 SymbolicEngine.LinkArray(5).AbsoluteFollower(:)];
...
Task = [SymbolicEngine.LinkArray(21).AbsoluteFollower(:)]; 
%%%%%%%%%
